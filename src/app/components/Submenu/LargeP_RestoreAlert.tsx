    ...
    <div>
      <AlertDialog>
        <AlertDialogTrigger asChild className='translate-x-[0.1rem]'>
            <Button onClick={(e) => {e.stopPropagation()}} className='rounded-lg text-sm w-[16rem] py-3  bg-slate-100 text-left hover:bg-slate-200 transition-colors' variant='ghost'>Restore Project</Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
            <AlertDialogHeader>
